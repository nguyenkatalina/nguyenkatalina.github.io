...
function newkeyChoice(toolChoice) { //toolchoice is the key that was pressed
 ...
 if (toolChoice == '1' ) {  // first tool
    ...
    fill(255,255,255);
    circle(mouseX-40,mouseY-5, 40)
    fill(255,255,255);
    circle(mouseX+40,mouseY-5, 40)
    fill(0);
    circle(mouseX-40,mouseY-5, 20)
    fill(0);
    circle(mouseX+40,mouseY-5, 25)
    noFill();
    stroke(200);
    arc(mouseX, mouseY+40, 30, 30, 0, PI + QUARTER_PI, CHORD);
